 ...
 *
 * @example
 * checkNumhy778w(1, 2); // No error thrown
 * checkNumhy778w(NaN, 5); // Throws Error: "First parameter must be a finite number..."\n */
export function checkNumhy778w(a: unknown, b: unknown): void {
